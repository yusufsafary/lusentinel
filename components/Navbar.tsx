      ...
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-xl border border-[rgba(255,255,255,0.07)] text-[#606060] hover:text-white hover:border-[rgba(255,255,255,0.18)] hover:bg-white/[0.03] transition-all duration-200 text-sm"
          >
            <XIcon size={13} />
