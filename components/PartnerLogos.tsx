...
const logos = [
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        <svg width="20" height="15" viewBox="0 0 397 311" fill="none">
          ...
          <path d="M64.6 3.8C67.1 1.4 70.4 0 73.8 0h317.4c5.8 0 8.7 7 4.6 11.1L333.1 73.8c-2.4 2.4-5.7 3.8-9.2 3.8H6.5C.7 77.6-2.2 70.6 1.9 66.5L64.6 3.8z" fill="url(#sol-grad)"/>
        ...
        <span className="text-white text-sm font-semibold tracking-tight">Solana</span>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-semibold tracking-tight">Coinbase</span>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-semibold tracking-tight">Chainlink</span>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-semibold tracking-tight">alchemy</span>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-semibold tracking-tight">Jupiter</span>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-semibold tracking-tight">Uniswap</span>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-semibold tracking-tight">Polymarket</span>
      </div>
    ),
  },
  {
    name: '0x',
    render: () => <span className="text-white font-black text-xl tracking-tight">0x</span>,
  },
  {
    name: 'Quicknode',
    render: () => <span className="text-white font-semibold text-sm tracking-tight">Quicknode</span>,
  },
  {
    name: 'Circle',
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-bold tracking-widest">CIRCLE</span>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-white text-sm font-bold tracking-widest">LI.FI</span>
      </div>
    ),
  },
];
...
export default function PartnerLogos() {
  ...
  return (
    <section className="py-8 border-t border-b border-[rgba(255,255,255,0.05)] overflow-hidden">
      {/* Single global gradient definition for Solana */}
      ...
      <div className="relative overflow-hidden">
        ...
        >
          {[...logos, ...logos].map((logo, i) => (
            <div key={i} className="opacity-30 hover:opacity-70 transition-all duration-300 cursor-default shrink-0">
              {logo.render()}
            </div>
          ))}
        </div>
